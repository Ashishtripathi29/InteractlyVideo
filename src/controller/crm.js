...
const apiKey = "aQBLr5z-GlGoOoDqK5Ea3w"
let baseurl = "https://functionup-545493100824234875.myfreshworks.com/crm/sales/api/contacts"
...
const getContactWithCRM = async (req, res) => {
    try {
        ...
        let outData = await axios.get(
            `https://functionup-545493100824234875.myfreshworks.com/crm/sales/api/contacts/${contact_id}`,
